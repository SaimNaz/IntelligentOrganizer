...
return false;
    ...
    <div class="container">
        ...
        <div class="mpane">
            ...
            String category = request.getParameter("fore"); 
        Class.forName("oracle.jdbc.driver.OracleDriver");
        Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "system", "123456");
            Statement statement = con.createStatement() ;
            ResultSet resultset = 
                statement.executeQuery("select store,moretype,location,name,address,contact,email from store where store = '" + category + "'") ; 

           
        %>

            <br>
<p style="font-size: xx-large">            <% out.println("Your Result For '"+category+"' Are "); %></p>
            <br>
            
            
        <TABLE BORDER="2px" cellspacing="35" cellpadding="10" bgcolor="" >
