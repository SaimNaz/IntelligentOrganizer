...
public final class admin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <form name=\"form\" method=\"get\" action=\"verify1.jsp\">\n");
      out.write("                        \n");
      out.write("                    <br>\n");
      out.write("            <p style=\"font-size: xx-large\">            List of not verified third party</p>\n");
      out.write("            <br>  \n");
      out.write("            \n");
      out.write("              ");
        ...
        Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "system", "123456");
            ...
            ResultSet resultset = 
                statement.executeQuery("select tin from store where status ='NO'") ; 
            if(!resultset.next()) {
               
               response.sendRedirect("allverified.jsp");
      ...
      out.write("       \n");
      out.write("                \n");
      out.write("        <TABLE BORDER=\"2\" cellspacing=\"35\" cellpadding=\"0\" >\n");
      out.write("\n");
      out.write("            <TR>\n");
      out.write("                <TH> <u>TIN NUMBER</u></TH>\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("\" name=\"verifytin\" id=\"verifytin\"> ");
      out.print( resultset.getString(1) );
      out.write("</TD>\n");
      out.write("\n");
      out.write("\n");
