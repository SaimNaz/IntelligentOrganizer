...
<html>
   ...
   <div class="top">
    ...
    <div class="container">
        ...
        <div class="mpane">
            <form name="form" method="get" action="verify1.jsp">
                        
                    <br>
            <p style="font-size: xx-large">            List of not verified third party</p>
            <br>  
        ...
        <TABLE BORDER="2" cellspacing="35" cellpadding="0" >

            <TR>
                <TH> <u>TIN NUMBER</u></TH>
  ...
  <% 
      while(resultset.next()){ %> 
            ...
            <TR>
                ...
                <TD><input type="checkbox" value="<%= resultset.getString(1) %>" name="verifytin" id="verifytin"> <%= resultset.getString(1) %></TD>
