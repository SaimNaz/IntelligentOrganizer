   ...
   <div class="top">
    ...
    <div class="container">
        ...
        <div class="mpane">
            <br>
            <br>
            <p style="font-size: xx-large"><b>About Us</b></p>
            <br>
            <p style="font-size: large">
                We are pursuing B. Tech from UIET Chhatrapati Shahu Ji Maharaj University Kanpur. And this website is a part of our final year B.Tech Project under our Project Guide.
            </p>
            <p style="font-size: large">
            <br>COLLEGE : 
                <br>University Institute of Engineering And Technology 
                <br>Chhatrapati Shahu Ji Maharaj University 
                <br>Kanpur
            </p>
            <p style="font-size: large">
                <br>
                ...
                Project Guide
                <br>Dr. Renu Jain
                <br>HOD Computer Science and Engineering Department
                <br>UIET CSJM University, Kanpur
            </p>
